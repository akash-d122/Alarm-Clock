const currentTime = document.querySelector("#present-time");
...
// Alarms set by user Dislayed in page
function addAlaramToDom(time, intervalId) {
  const alarm = document.createElement("div");
  alarm.classList.add("alarm", "mb", "r-flex");
  alarm.innerHTML = `
...
// Is alarms saved in Local Storage check
